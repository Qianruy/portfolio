      ...
      <Grid.Row>
        ...
        <Grid.Column computer={10} mobile={16} tablet={8}>
          ...
          <Education
            ...
            addtional2="Research Focus: Design algorithmic solutions for large-scale systems, bridging networking, storage, and distributed computing to improve throughput, reliability, and latency"
          />
          <Education
            startYear="Jan 2022"
            endYear="May 2024"
          ...
          <Experience
            ...
            startYear="Jan 2023"
            endYear="May 2023"
            jobDescription="Tutoring project teams: Support students in developing novel ideas and provide hands-on mentorship to implement proof-of-concepts and experiments." />
            ...
            <Grid.Row>
              <Grid.Column width={11}>
                ...
                <p style={{ marginTop: "0px", color:"#ccd6f6"}}>
                  Motion Control with Reinforcement Learning
                </p>
                <div class="ui bulleted list">
                  <div class="item" style={{ fontSize: "13px", color:"#8892b0"}}>
                    <b>Modeling:</b> Modeling and simulation using MATLAB, including motor control model, hydraulic system and other modules.
                  </div>
                  <div class="item" style={{ fontSize: "13px", color:"#8892b0"}}>
                    <b>Algorithm Design:</b> Using Deep Deterministic Policy Gradient algorithms to improve the accuracy and robustness of output motion. Design module of observation, action, and reward signal function.
                  </div>
                  <div class="item" style={{ fontSize: "13px", color:"#8892b0"}}>
                    <b>Testing:</b> Created input signal under different configurations and compare the results with traditional PID control.
                  </div>
                </div>
              </Grid.Column>
